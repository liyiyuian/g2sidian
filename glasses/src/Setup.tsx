...
export function Setup({ onSave }: { onSave: () => void }) {
  ...
  return (
    <div style={wrap}>
      ...
      <input id="cfg-url" type="url" inputMode="url" style={input} value={base} onChange={(e) => { setBase(e.target.value); setErr('') }} placeholder="your backend's HTTPS address" autoCapitalize="off" autoCorrect="off" spellCheck={false} />
